                ...
                @foreach ($users as $user)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2 text-center">
                            ...
                            <button wire:click="confirmDelete({{ $user->id }})" class="bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700 ml-2">
    ...
    <div class="mt-6">
     ...
     <div class="fixed inset-0 flex justify-center items-center">
         <div class="bg-white p-6 rounded shadow-lg">
             ...
             <div class="flex justify-center space-x-4">
                 <button wire:click="delete" class="bg-red-600 text-white px-4 py-2 rounded-lg">Delete</button>
                 <button wire:click="$set('confirmingDelete', false)" class="bg-gray-600 text-white px-4 py-2 rounded-lg">Cancel</button>
             </div>
         </div>
     </div>
 @endif
